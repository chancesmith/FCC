...
<head>
    ...
    <title>First Christian Church Jackson, TN</title>
...
<body id="page-top" class="index">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <p>Recently we had a baptism and a new member, Leslie Hughey, joined our church family.</p>
        </div>
        <div class="col-md-6">
          <img src="img/fcc-baptism.jpg" class="img-responsive" alt="First Christian Church Supporting Jackson Police Department">
        </div>
      </div>
    </div>
  </section>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <p>Copyright &copy; First Christian Church 2016+</p>
        </div>
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            <li><a href="https://www.facebook.com/First-Christian-Church-140273226274/"><i class="fa fa-facebook fa-2x"></i></a>
            </li>
          </ul>
        </div>
        <div class="col-md-4">
